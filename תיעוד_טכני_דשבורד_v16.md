...
- GitHub Pages: https://roybenyamini-stack.github.io/Financial-Dashboard/dashboard_v16.html
...
| קובץ | תיאור |
|---|---|
| `dashboard_v16.html` | הדשבורד הפעיל |
| `asset_data.xlsx` | נתוני השקעות |
| `תזרים_חדשי_2022.xlsx` | נתוני תזרים שוטף |
| `כללי_עדכון_דשבורד_v16.md` | הוראות עדכון |
| `תיעוד_טכני_דשבורד_v16.md` | מסמך זה |
